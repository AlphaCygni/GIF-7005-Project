...
with mlflow.start_run() as run:
    ...
    for epoch in range(params["epochs"]):
        ...
        for batch in train_loader:
            ...
            predicted_normalized = model(batch)
            
            # Loss is calculated on the normalized values
            loss = loss_fn(predicted_normalized, batch.y)
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                val_loss = loss_fn(predicted_normalized, batch.y)
...
print("\nTo view your results, run 'mlflow ui' in your terminal and open http://127.0.0.1:5000")